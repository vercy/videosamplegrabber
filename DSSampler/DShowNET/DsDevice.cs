...
namespace DSSampler.DShowNET.Device
{
	...
	public class DsDev
	{
		...
		public static bool GetDevicesOfCat( Guid cat, out ArrayList devs )
		{
			...
			try {
				...
				do
				{
					...
					dev.Name = GetProperty( mon[0], "FriendlyName" );
		...
		/// <summary>
		/// Modified to be able to return arbitrary property.
		/// </summary>
		/// <param name="mon"></param>
		/// <returns></returns>
		public static string GetProperty( UCOMIMoniker mon, string _prop )
		{
			object bagObj = null;
			...
			try {
				...
				object val = "";
				int hr = bag.Read( _prop, ref val, IntPtr.Zero );
				if( hr != 0 )
